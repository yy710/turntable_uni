...
<script>
  ...
  const { request51, webSocketConnect, validMobile } = require('../../utils/util.js');
  //import parseHtml from '../../utils/html-parser.js';
    ...
    async onLoad(){
      const res = await request51('login');
      ...
      onLogin(res){
        ...
        if(sid){
          // get radom number
          const res = await request51('getSelect');
      ...
      onGameOver(index){
        ...
        request51('saveAward', { finalSelect: index, key: this.key, appToken: 'holiday51' })
        .then(res => {
